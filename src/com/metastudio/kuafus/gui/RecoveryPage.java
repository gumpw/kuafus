 ...
 */
package com.metastudio.kuafus.gui;
...
/** 短信注册页面*/
public class RecoveryPage extends FakeActivity implements OnClickListener, TextWatcher {
	...
	public void onCreate() {
		...
		if (resId > 0) {
			...
			resId = getStringRes(activity, "smssdk_recovery");
			if (resId > 0) {
				tv.setText(resId);
			}
